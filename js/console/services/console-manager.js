(function () {
  ...
  /**
   * @ngdoc service
   * @name automation.ConsoleManager
   ...
   * @ngInject
   **/
  function service($log, $q, CONFIG, ConsoleModel, DataService, _) {
     ...
     * @ngdoc property
     * @name currentConsole
     * @propertyOf automation.ConsoleManager
     * @description
     ...
     * @methodOf automation.ConsoleManager
     * @description
     ...
     * @methodOf automation.ConsoleManager
     * @description
     * Uses the DataService to fetch available consoles and parse the response.
     *
    ...
    function getAvailableConsoles() {
      ...
      DataService.get(config.SERVICES.GET_AVAILABLE_CONSOLES, data, params)
    ...
    function getAvailablePortlets() {
      ...
      if (availablePortlets) {
        ...
        DataService.get(config.SERVICES.GET_AGENCY_PORTLETS, data, params)
          .then(function(response) {
            var portlets = [];
            var status = response.data.status;
            var content = response.data.content;
    ...
    function getUserConsole(selectedConsole) {
      ...
      DataService.get(config.SERVICES.GET_USER_CONSOLE, data, params).then(function(response) {
        var status = response.data.status;
        var content = response.data.content;
    ...
    function saveConsole(currentConsole) {
      ...
      DataService.post(config.SERVICES.SAVE_USER_CONSOLE, savedConsole)
        .then(function(response) {
          var status = response.data.status;
          var content = response.data.content;
