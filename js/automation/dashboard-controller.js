(function() {
   ...
   * @ngInject
   */
  function controller($scope, $filter, $log, _) {
...
//      });
//
      $scope.dashboard.currentUser = Accela.Utils.XmlHttp.getMockData('mock-api/dashboard/getUserInfo.json').content;
    };
...
//      var data = mockPermitResponse.result[0];
      var data = Accela.Utils.XmlHttp.getMockData('mock-api/dashboard/records-BPTDEV-DUB13-00000-00003.json').content[0];
